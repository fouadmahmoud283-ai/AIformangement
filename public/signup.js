...
const handleFormSubmit = async (e) => {
    ...
    if (!allValid) {
        ...
        const firstInvalidField = form.querySelector('.form-input.error, input:invalid');
    ...
    try {
        ...
        if (response.ok) {
            ...
            setTimeout(() => {
                ...
                console.log('Signup successful! Redirect to dashboard would happen here.');
            }, 2000);
        } else {
...
const setupAccessibility = () => {
    ...
    [emailError, usernameError, passwordError, confirmPasswordError, termsError].forEach(element => {
